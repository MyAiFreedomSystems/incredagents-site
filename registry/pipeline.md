...
|---|---|---|---|---|---|---|---|
| harvest-testimonials | skill-fixes/harvest-testimonials | useful + standalone | **published** | ⚠ MIT file present — owner said NOT MIT (2026-08-10); needs her decision | TBD | [MyAiFreedomSystems/harvest-testimonials](https://github.com/MyAiFreedomSystems/harvest-testimonials) | Live; YAML frontmatter fixed 2026-08-14 (unquoted colon broke skills.sh). Registry previously claimed MIT/free per stale row — repo ships an MIT LICENSE file that predates the owner's "not MIT" direction; flagged, not silently changed |
| graphic-testimonials | managed skills | useful + standalone | **published** | all rights reserved (terms TBD) — no LICENSE file in repo | TBD | [MyAiFreedomSystems/graphic-testimonials](https://github.com/MyAiFreedomSystems/graphic-testimonials) | Live; registry row previously said MIT — repo has no LICENSE file, corrected 2026-08-14 |
...
| hooks-guide | skill-src/hooks-guide.md | useful + standalone | **published** | all rights reserved (terms TBD) | TBD | [MyAiFreedomSystems/hooks-guide](https://github.com/MyAiFreedomSystems/hooks-guide) | v1.0.0 released 2026-08-14. Scrub clean; QA caught owner-infra mention (Hermes interface list) — fixed pre-publish |
| provision-project | skill-src/provision-project.md | useful + standalone | **published** | all rights reserved (terms TBD) | TBD | [MyAiFreedomSystems/provision-project](https://github.com/MyAiFreedomSystems/provision-project) | v1.0.0 released 2026-08-14. Scrub clean; QA caught README/skill mismatch (.cursorrules) — fixed pre-publish |
